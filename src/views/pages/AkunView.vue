                ...
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-primary">
                            Tabel laundry yaitu tabel dimana menampung semua data laundry Akun
                        </p>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title float-start">Data Account</h4>
                                ...
                                <table class="table table-light mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><a role="button" @click="sortingData(meta.sort, 'email')"><font-awesome-icon
                                                        :icon="meta.sortIcon.email" /> Email</a></th>
                                            <th><a role="button"
